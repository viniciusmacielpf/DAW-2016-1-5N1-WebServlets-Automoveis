            ...
            <input id="acao" name="acao" type="hidden">
                    ...
                    : marcaDao.getObjetoSelecionado().getId()%>" readonly size="6">
                      ...
                      : marcaDao.getObjetoSelecionado().getNome()%>"  size="40">
                        Nacionalidade<input type="text" name="nacionalidade" value="<%=marcaDao.getObjetoSelecionado().getNacionalidade()== null ? ""
                      : marcaDao.getObjetoSelecionado().getNacionalidade()%>"  size="40">
